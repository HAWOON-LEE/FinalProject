...
function heartClick(btnEl){
  const number = btnEl.nextElementSibling;
  ...
  if (btnEl.classList.contains("active")) {
    if (!btnEl.classList.contains("fallow")) {
      btnEl.classList.add("fallow");
      count++;
    } else {
      btnEl.classList.remove("fallow");
      count--;
    }
    setTimeout(function () {
